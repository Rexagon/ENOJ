...
{
	if (!m_diffuseTexture) {
		m_diffuseTexture = TextureManager::Get("images/default_diffuse.png");
	}

	if (!m_normalTexture) {
		m_normalTexture = TextureManager::Get("images/default_normal.png");
	}

	if (!m_specularTexture) {
		m_specularTexture = TextureManager::Get("images/default_specular.png");
	}
}
